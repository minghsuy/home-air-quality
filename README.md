...
More depth on the method and the airflow math lives in [docs/filter-efficiency.md](docs/filter-efficiency.md).
...
There's a fuller playbook in [docs/wildfire-smoke.md](docs/wildfire-smoke.md).
...
Released under the [MIT License](LICENSE). Educational content, provided as-is; see the disclaimer at the top. Contributions welcome.
